...
source("fun.R")
library(data.table) # for function in readcsv2 fread

# read calibration data
df1 <- readcsv2("calvoor1_05_04.csv", compressed = T)
calBefore <- calibrate(df1)

df2 <- readcsv2("calna1_05_04.csv", compressed = T)
...
# read test data
test <- readcsv2("test1_05_04.csv", compressed = T)
